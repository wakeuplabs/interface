...
export const marketsData: {
  ...
  [CustomMarket.proto_alpen_testnet_v3]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xE2590393F5D79361252711d9051d40c331Ea4532',
      LENDING_POOL: '0xfe7E65279C0992Afd1B5B4e6a470262870A9E2Ce',
      WETH_GATEWAY: '0x7c516600D3E59bB0b70fAFDD2E6384F19dD9FD26',
      FAUCET: '0x3a3d4D971f194498dd7E3f89dB97a842ce3554d3',
      WALLET_BALANCE_PROVIDER: '0xBf4ce259fc220D1dD761fF735187C23DD9C7dA1F',
      UI_POOL_DATA_PROVIDER: '0xFbdBcA77d891Bb4a0C324A211874c79F3ac7f277',
      UI_INCENTIVE_DATA_PROVIDER: '0x901d458CA18ED0273867B7aC2aEdc01BAbFf1fA9',
    },
  },
} as const;
